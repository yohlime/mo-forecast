...
IN_DIR = '/home/modelman/forecast/output/timeseries/csv/20210911/00'
stn_id = 'MOIP'
...
fig, (ax1,ax2,ax4,ax5,ax7) = plt.subplots(ncols=1,nrows=5,constrained_layout=True)
...
ax1.axvline(x=72, ymin=-0.1, ymax=5,linestyle='dotted', color='gray',)
ax1.axvline(x=96, ymin=-0.1, ymax=5,linestyle='dotted', color='gray',)
...
if ymax1 <= 5:
    ...
    ax1.axhline(y=5, xmin=xmin1, xmax=xmax1,linestyle='dotted', color='gray')
    ax1.axhline(y=10, xmin=xmin1, xmax=xmax1,linestyle='dotted', color='gray')
    ax1.axhline(y=15, xmin=xmin1, xmax=xmax1,linestyle='dotted', color='gray')
    ax1.axhline(y=20, xmin=xmin1, xmax=xmax1,linestyle='dotted', color='gray')
    ax1.axhline(y=25, xmin=xmin1, xmax=xmax1,linestyle='dotted', color='gray')
    ax1.axhline(y=30, xmin=xmin1, xmax=xmax1,linestyle='dotted', color='gray')
   
    ax1.fill_between(x_range, 7.5, 15, color='yellow', alpha=0.5,label='Heavy (7.5-15 mm/hr)')
    ax1.fill_between(x_range, 15,  30, color='orange', alpha=0.5,label='Intense (15-30 mm/hr)')
    ax1.fill_between(x_range, 30,  50, color='red'   , alpha=0.5,label='Torrential (> 30 mm/hr)')
...
ax1.set_ylim([-0.1, 40])
ax1.set_xlim([-2,121])
ax1.tick_params(axis='x', labelsize=22,labelrotation=30)
#ax1.set_xticklabels([])
ax1.tick_params(axis='y', labelsize=24)
ax1.legend(loc='lower center',bbox_to_anchor=(0.5,-0.8),fontsize=20,ncol=3,title_fontsize='20',
        title="Colors in the rainfall time series are based on DOST-PAGASA's color-coded rainfall advisories and classification:")
ax1.set_title(f'Ensemble Forecast ({station_name})\nInitialized at {yyyymmdd} {init}:00 PHT', pad=38,fontsize=30)
ax1.set_ylabel("Rainfall (mm/hr)",size=24,color='blue')
...
ax2.plot(x_range, HI, '-', color='purple',marker='.', linewidth=3,markersize=12,label='Heat Index (°C)')
ax2.plot(x_range, T_dat, '-', color='red', marker='.', linewidth=3,markersize=12,label='Temperature (°C)')
...
ax2.legend(loc='lower center',bbox_to_anchor=(0.415,-0.22),fontsize=20,ncol=2)
ax2.set_ylabel("Temp/HI (°C)",size=24,color='red')
...
ax3.legend(loc='lower center',bbox_to_anchor=(0.65,-0.22),fontsize=20,ncol=2)
ax3.set_ylabel("Relative Humidity (%)",size=24,color='green')
...
ax4.set_xlim([-2,121])
ax4.set_ylim([0, 20])
ax4.tick_params(axis='x', labelsize=22,labelrotation=30)
#ax4.set_xticklabels([])
ax4.tick_params(axis='y', labelsize=24)
ax4.set_ylabel("Wind Speed (m/s)",size=24,color='black')
...
#ax5.set_ylim([0, 4])
ax5.tick_params(axis='x', labelsize=22, labelrotation=30)
ax5.set_xticklabels([])
ax5.tick_params(axis='y', labelsize=24)
ax5.set_title(f'Clean Power Ensemble Forecast ({station_name})\nInitialized at {yyyymmdd} {init}:00 PHT',
              pad=38,fontsize=30)
ax5.set_ylabel('Wind PP (MW)',size=24,color='black')
...
ax5.axhline(y=8, xmin=xmin1, xmax=xmax1,linestyle='dotted', color='gray', zorder=0)
ax5.axhline(y=10, xmin=xmin1, xmax=xmax1,linestyle='dotted', color='gray', zorder=0)
ax5.axhline(y=12, xmin=xmin1, xmax=xmax1,linestyle='dotted', color='gray', zorder=0)
ax5.axhline(y=14, xmin=xmin1, xmax=xmax1,linestyle='dotted', color='gray', zorder=0)
...
ax7.set_ylim([0, 2])
ax7.tick_params(axis='x', labelsize=22,labelrotation=30)
ax7.tick_params(axis='y', labelsize=24)
ax7.legend(loc='upper right',fontsize=24)
ax7.set_ylabel("Solar PP (MW)",size=24,color='black')
ax7.set_xlabel("Day and Time (PHT)",size=24)
...
if ymax5 <=0.1:
    ...
    ymax51 = ymax5
if init == '20':
    ax1.text(12, ymax11+(ymax11*0.05), x_range2[12], fontsize=26,ha='center')
    ax1.text(36, ymax11+(ymax11*0.05), x_range2[36], fontsize=26,ha='center')
    ax1.text(60, ymax11+(ymax11*0.05), x_range2[60], fontsize=26,ha='center')
    ax1.text(84, ymax11+(ymax11*0.05), x_range2[84], fontsize=26,ha='center')
    ax1.text(108, ymax11+(ymax11*0.05), x_range2[108], fontsize=26,ha='center')
    ax5.text(12, ymax51+(ymax51*0.05), x_range2[12], fontsize=26,ha='center')
    ax5.text(36, ymax51+(ymax51*0.05), x_range2[36], fontsize=26,ha='center')
    ax5.text(60, ymax51+(ymax51*0.05), x_range2[60], fontsize=26,ha='center')
    ax5.text(84, ymax51+(ymax51*0.05), x_range2[84], fontsize=26,ha='center')
    ax5.text(108, ymax51+(ymax51*0.05), x_range2[108], fontsize=26,ha='center')

else:
    ax1.text(12, ymax11+(ymax11*0.05), x_range2[0], fontsize=26,ha='center')
    ax1.text(36, ymax11+(ymax11*0.05), x_range2[24], fontsize=26,ha='center')
    ax1.text(60, ymax11+(ymax11*0.05), x_range2[48], fontsize=26,ha='center')
    ax1.text(84, ymax11+(ymax11*0.05), x_range2[72], fontsize=26,ha='center')
    ax1.text(108, ymax11+(ymax11*0.05), x_range2[96], fontsize=26,ha='center')
    ax5.text(12, ymax51+(ymax51*0.05), x_range2[0], fontsize=26,ha='center')
    ax5.text(36, ymax51+(ymax51*0.05), x_range2[24], fontsize=26,ha='center')
    ax5.text(60, ymax51+(ymax51*0.05), x_range2[48], fontsize=26,ha='center')
    ax5.text(84, ymax51+(ymax51*0.05), x_range2[72], fontsize=26,ha='center')
    ax5.text(108, ymax51+(ymax51*0.05), x_range2[96], fontsize=26,ha='center')
