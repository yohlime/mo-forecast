...
df=pd.read_csv(Path(OUT_DIR) / f"csv/MOD_forecast_{yyyymmdd}_{init}PHT.csv",na_values='-999000000')
...
out_file = Path(OUT_DIR) / f'img/forecast_MOD_{yyyymmdd}_{init}PHT.png'
