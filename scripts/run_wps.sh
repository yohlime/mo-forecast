...
echo "------------------"
srun -n 1 ./geogrid.exe >& log.geogrid & tail --pid=$! -f log.geogrid
echo "------------------"
echo " End of Geogrid "
echo "------------------"
...
echo "------------------"
srun -n 1 ./ungrib.exe >& log.ungrib & tail --pid=$! -f log.ungrib
echo "------------------"
echo " End of Ungrib "
echo "------------------"
...
echo "------------------"
srun ./metgrid.exe >& log.metgrid & tail --pid $! -f log.metgrid
echo "------------------"
echo " End of Metgrid "
echo "------------------"
